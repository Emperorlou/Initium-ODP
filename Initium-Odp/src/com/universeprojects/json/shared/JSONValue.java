...
public class JSONValue {
	 ...
	 * 
	 * @see org.json.simple.parser.JSONServerParser#parse(Reader)
	 ...
	 * Parse JSON text into java object from the input source.
	 * 
	 * @see org.json.simple.parser.JSONServerParser
	 * 
	 * @param in
	 * @return Instance of the following:
	 * 	org.json.simple.JSONObject,
	...
	public static Object parseWithException(String s) throws ParseException{
		return JSONParserFactory.getParser().parse(s);
	}
...
com.universeprojects.json.sharedhe first parameter, use JSONObject.writeJSONString(com.universeprojects.json.shared JSONArray.writeJSONString(List, Writer) instead.
	...
	public static void writeJSONString(Object value, Writer out, final String indent) throws IOException {
		...
		if((value instanceof JSONStreamAware)){
			((JSONStreamAware)value).writeJSONString(out, indent);
			return;
		}
		...
		if(value instanceof Map){
			JSONObject.writeJSONString((Map)value, out, indent);
			return;
		}

		if(value instanceof List){
			JSONArray.writeJSONString((List)value, out, indent);
			return;
		}
