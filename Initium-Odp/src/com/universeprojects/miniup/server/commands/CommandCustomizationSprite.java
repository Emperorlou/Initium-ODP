...
import com.universeprojects.miniup.server.GameFunctions.CustomOrderStatus;
import com.universeprojects.miniup.server.GameUtils;
import com.universeprojects.miniup.server.ODPDBAccess;
import com.universeprojects.miniup.server.ServletMessager;
...
public class CommandCustomizationSprite extends Command
{
	...
	private void doOrderItemSpriteUpdate(final CachedEntity finalUser, final CachedEntity finalCharacter, final CachedEntity finalItem, Key customizationStoreItemDefKey) throws UserErrorMessage {
		try
		{
			...
			ServletMessager.addGlobalMessage(ds, finalCharacter.getProperty("name")+" has ordered an item customization! To order one for yourself, <a onclick='customizeItemOrderPage()'>check out this page</a>.");
		}
