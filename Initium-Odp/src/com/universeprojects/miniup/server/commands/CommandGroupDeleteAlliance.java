...
public class CommandGroupDeleteAlliance extends Command {

	public CommandGroupDeleteAlliance(ODPDBAccess db, HttpServletRequest request,
	...
	public void run(Map<String, String> parameters) throws UserErrorMessage {
		...
		if (service.deleteAlliance(ds, group))
		{
