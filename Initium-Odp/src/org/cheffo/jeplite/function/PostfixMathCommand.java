...
public abstract class PostfixMathCommand
{
  ...
  public static void fillFunctionTable(HashMap funTab) {
    ...
    funTab.put("ceiling", new Ceiling());
  ...
  static class Floor extends PostfixMathCommand
  {
    public Floor()
    {
      numberOfParameters = 1;
  ...
  static class Ceiling extends PostfixMathCommand
  {
    public Ceiling()
    {
      numberOfParameters = 1;
  ...
  static class Round extends PostfixMathCommand
  {
    public Round()
    {
      numberOfParameters = 1;
