	...
	<div class='normal-container'>
		...
		<div class='item-popup-header'>
			<div class='icon'>
				...
				<c:if test="${slot.slotIsEmpty == false}"><div class='socket-base'></div><div class = 'socket-item' <img src='${slot.slotIcon}'/> minitip='${slot.slotName} <br> ${slot.slotModifierText}'></div></c:if>
				</c:forEach>
			</div>
