...
function openMap()
{
	...
	$("#page-popup-root").append("<div id='"+pagePopupId+"' class='page-popup v3-window1'><a class='page-popup-Reload' onclick='reloadPagePopup()'>&#8635;</a><a class='page-popup-X' onclick='closePagePopup()'>X</a><center><h3>Player-Made Game Map</h3><br/><span>Last updated: June 26, 2017</span></center><div id='"+mapId+"' class='page-popup-map'></div></div>");
