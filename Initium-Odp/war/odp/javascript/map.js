...
function openMap()
{
	...
	$("#page-popup-root").append("<div id='"+pagePopupId+"' class='page-popup v3-window1'><center><h3>Player-Made Game Map</h3><br/><span>Last updated: June 26, 2017</span></center><div id='"+mapId+"' class='page-popup-map'></div></div>");
